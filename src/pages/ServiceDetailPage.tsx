        ...
        <div className="pt-12 border-t border-[#E5E7EB] dark:border-gray-800 max-w-4xl space-y-6">
          ...
          <div className="prose dark:prose-invert max-w-none text-base sm:text-lg text-[#334155] dark:text-gray-300 leading-relaxed font-normal space-y-6 bg-[#F8FAFC] dark:bg-gray-900/80 p-6 sm:p-10 rounded-3xl border border-[#E2E8F0] dark:border-gray-800 shadow-sm">
            <Markdown
              ...
              components={{
                h2: ({node, ...props}) => <h2 className="text-xl sm:text-3xl font-black text-gray-900 dark:text-white mt-8 mb-4 border-b pb-3 border-gray-200 dark:border-gray-800" {...props} />,
                h3: ({node, ...props}) => <h3 className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white mt-6 mb-3 text-[#1e293b] dark:text-gray-100" {...props} />,
                ...
                p: ({node, ...props}: any) => {
                  ...
                  return <p className="leading-8 text-[#475569] dark:text-gray-300 mb-5 text-base sm:text-lg" {...props} />;
                },
                ul: ({node, ...props}) => <ul className="list-disc list-inside space-y-2 mb-6 ml-4 text-[#475569] dark:text-gray-300 text-base sm:text-lg" {...props} />,
                ol: ({node, ...props}) => <ol className="list-decimal list-inside space-y-2 mb-6 ml-4 text-[#475569] dark:text-gray-300 text-base sm:text-lg" {...props} />,
                li: ({node, ...props}) => <li className="leading-7" {...props} />,
                strong: ({node, ...props}) => <strong className="font-extrabold text-gray-900 dark:text-white" {...props} />,
                blockquote: ({node, ...props}) => (
                  <blockquote className="border-l-4 border-[#4285F4] pl-5 py-3 my-6 bg-blue-50/70 dark:bg-blue-950/30 rounded-r-2xl italic text-[#334155] dark:text-gray-200 shadow-sm" {...props} />
                ),
                table: ({node, ...props}) => (
                  <div className="overflow-x-auto my-6 border border-gray-200 dark:border-gray-800 rounded-2xl">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800 text-left text-sm" {...props} />
                  </div>
                ),
