    ...
    <div className="space-y-16 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto animate-in fade-in duration-300">
      ...
      {currentPage === 1 && !searchQuery && selectedCat === 'All' && featuredPost && (
        <a 
          ...
          onClick={(e) => { e.preventDefault(); onSelectPost(featuredPost.slug); }}
          className={`block rounded-3xl border overflow-hidden cursor-pointer transition-all hover:shadow-2xl group ${
