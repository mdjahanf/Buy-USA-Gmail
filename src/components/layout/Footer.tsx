    ...
    <footer className={`border-t transition-colors ${
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            {(services || []).map(s => (
              <li key={s.id}>
                <a
                  ...
                  onClick={(e) => { e.preventDefault(); onNavigate('service-detail', s.slug); }}
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2.5 text-sm">
            <li>
              <a href="/about" onClick={(e) => { e.preventDefault(); onNavigate('about'); }} className="text-gray-400 hover:text-white transition-colors">
                About buyusagmail.com
              </a>
            </li>
            <li>
              <a href="/pricing" onClick={(e) => { e.preventDefault(); onNavigate('pricing'); }} className="text-gray-400 hover:text-white transition-colors">
                Wholesale Pricing Calculator
              </a>
            </li>
            <li>
              <a href="/payment-methods" onClick={(e) => { e.preventDefault(); onNavigate('payment-methods'); }} className="text-gray-400 hover:text-white transition-colors">
                Crypto Wallet Addresses
              </a>
            </li>
            <li>
              <a href="/blog" onClick={(e) => { e.preventDefault(); onNavigate('blog'); }} className="text-gray-400 hover:text-white transition-colors flex items-center gap-1.5">
            ...
            <li>
              <a href="/faq" onClick={(e) => { e.preventDefault(); onNavigate('faqs'); }} className="text-gray-400 hover:text-white transition-colors">
                Frequently Asked Questions
              </a>
            </li>
            <li>
              <a href="/sitemap" onClick={(e) => { e.preventDefault(); onNavigate('sitemap'); }} className="text-gray-400 hover:text-white transition-colors">
                HTML & XML Sitemap
              </a>
            </li>
          </ul>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2.5 text-sm">
            <li>
              <a href="/terms" onClick={(e) => { e.preventDefault(); onNavigate('terms'); }} className="text-gray-400 hover:text-white transition-colors">
                Terms & Conditions
              </a>
            </li>
            <li>
              <a href="/privacy" onClick={(e) => { e.preventDefault(); onNavigate('privacy'); }} className="text-gray-400 hover:text-white transition-colors">
                Privacy Policy
              </a>
            </li>
            <li>
              <a href="/refund" onClick={(e) => { e.preventDefault(); onNavigate('refund'); }} className="text-gray-400 hover:text-white transition-colors">
                Refund & Warranty Policy
              </a>
            </li>
            <li>
              <a href="/dmca" onClick={(e) => { e.preventDefault(); onNavigate('dmca'); }} className="text-gray-400 hover:text-white transition-colors">
                DMCA Copyright Policy
              </a>
            </li>
            <li>
              <a href="/disclaimer" onClick={(e) => { e.preventDefault(); onNavigate('disclaimer'); }} className="text-gray-400 hover:text-white transition-colors">
                Legal Disclaimer
              </a>
            </li>
          </ul>
